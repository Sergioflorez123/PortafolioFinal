...
export default function Hero() {
  ...
  const subtitleDelay = useMemo(() => {
    const titleSpeed = 400;
    const titleDelay = 500;
    const pauseBetween = 800;
    return titleDelay + (titleWords.length * titleSpeed) + pauseBetween;
  }, [titleWords.length]);
  ...
  // Efecto de escritura para el subtítulo (empieza después del título)
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex gap-4 pt-4">
              ...
              <a
                href="https://github.com/sergioflorez" 
                target="_blank" 
                rel="noopener noreferrer"
                className="group relative flex items-center justify-center w-14 h-14 rounded-lg bg-gradient-to-br from-gray-700 to-gray-900 hover:from-gray-600 hover:to-gray-800 transition-transform duration-300 hover:translate-y-[-3px] hover:scale-105"
                style={{
