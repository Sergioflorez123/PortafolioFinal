         ...
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
           ...
           <ScrollAnimation animationType="fade-in-up" delay={150}>
             <div className="rounded-lg p-6 backdrop-blur-sm" style={{ background: 'var(--surface)', border: '1px solid var(--surface-border)' }}>
               ...
               <p className="text-sm mt-1" style={{ color: theme === 'light' ? '#6b7280' : '#9ca3af' }}>Java, Spring Boot, MySQL</p>
           ...
           <ScrollAnimation animationType="fade-in-up" delay={300}>
             <div className="rounded-lg p-6 backdrop-blur-sm" style={{ background: 'var(--surface)', border: '1px solid var(--surface-border)' }}>
               ...
               <p className="text-sm mt-1" style={{ color: theme === 'light' ? '#6b7280' : '#9ca3af' }}>Python, Django, PostgreSQL</p>
