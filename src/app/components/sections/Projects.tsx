           ...
           <ScrollAnimation animationType="fade-in-up" delay={0}>
             <div className="group rounded-lg overflow-hidden backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl flex flex-col h-full" 
               ...
               <div className="p-4 sm:p-6 flex flex-col flex-grow">
                 ...
                 <p className="text-sm mt-1 mb-3" style={{ color: theme === 'light' ? '#6b7280' : '#9ca3af' }}>{t('projects.ticket.stack')}</p>
                 ...
                 <div className="flex gap-3 mt-auto">
                   <a
                     href={LINKS.projects.ticket.demo}
                     target="_blank"
                   ...
                   >
                     ...
                     <span className="text-sm font-medium">{t('projects.cta.demo')}</span>
                   </a>
                   <a
                     href={LINKS.projects.ticket.repo}
                     target="_blank"
                     rel="noopener noreferrer"
                   ...
                   >
                     ...
                     <span className="text-sm font-medium">{t('projects.cta.repo')}</span>
                   </a>
                 </div>
               </div>
             </div>
           ...
           <ScrollAnimation animationType="fade-in-up" delay={150}>
             <div className="group rounded-lg overflow-hidden backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl flex flex-col h-full" 
               ...
               <div className="p-4 sm:p-6 flex flex-col flex-grow">
                 ...
                 <p className="text-sm mt-1 mb-3" style={{ color: theme === 'light' ? '#6b7280' : '#9ca3af' }}>{t('projects.news.stack')}</p>
           ...
           <ScrollAnimation animationType="fade-in-up" delay={300}>
             <div className="group rounded-lg overflow-hidden backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl flex flex-col h-full" 
               ...
               <div className="p-4 sm:p-6 flex flex-col flex-grow">
                 ...
                 <p className="text-sm mt-1 mb-3" style={{ color: theme === 'light' ? '#6b7280' : '#9ca3af' }}>{t('projects.calculator.stack')}</p>
                 ...
                 <div className="flex gap-3 mt-auto">
                   <a
                     href={LINKS.projects.calculator.demo}
                     target="_blank"
                     rel="noopener noreferrer"
                     className="flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-lg transition-all duration-300 hover:scale-105"
                     style={{ 
                   ...
                   <a
                     href={LINKS.projects.calculator.repo}
                     target="_blank"
                     rel="noopener noreferrer"
                     className="flex items-center justify-center gap-2 px-4 py-2 rounded-lg transition-all duration-300 hover:scale-105"
                     style={{ 
