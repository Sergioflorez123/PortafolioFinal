 ...
 const DICT: Dictionary = {
   es: {
    ...
    'about.skills': 'Habilidades',
     ...
     'projects.ticket.title': 'Ticket - Boarding Pass',
     'projects.ticket.desc': 'Aplicación web moderna para generar pases de abordar con diseño minimalista y elegante. Creado con Next.js y Tailwind CSS.',
     'projects.news.title': 'Página de Noticias',
     'projects.news.desc': 'Plataforma web interactiva para explorar y leer artículos de noticias con diseño responsivo y categorías organizadas. Desarrollada con Next.js y Tailwind CSS.',
     'projects.calculator.title': 'Calculadora Inteligente',
     'projects.calculator.desc': 'Calculadora inteligente que se basa en componentes de math con múltiples modos: Básica, Científica, Programador y Estadística. Incluye historial y memoria.',
   ...
   en: {
    ...
    'about.skills': 'Skills',
     ...
     'projects.ticket.title': 'Ticket - Boarding Pass',
     'projects.ticket.desc': 'Modern web application to generate boarding passes with minimalist and elegant design. Built with Next.js and Tailwind CSS.',
     'projects.news.title': 'News Page',
     'projects.news.desc': 'Interactive web platform to explore and read news articles with responsive design and organized categories. Developed with Next.js and Tailwind CSS.',
     'projects.calculator.title': 'Smart Calculator',
     'projects.calculator.desc': 'Smart calculator based on math components with multiple modes: Basic, Scientific, Programmer and Statistics. Includes history and memory.',
