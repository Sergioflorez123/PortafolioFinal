 ...
 const DICT: Dictionary = {
   es: {
    ...
    'about.skills': 'Habilidades',
     ...
     'projects.news.desc': 'Aplicación web moderna para visualizar noticias con diseño minimalista y elegante. Creado con Next.js y Tailwind CSS.',
   ...
   en: {
    ...
    'about.skills': 'Skills',
     ...
     'projects.news.desc': 'Modern web application to view news with minimalist and elegant design. Built with Next.js and Tailwind CSS.',
